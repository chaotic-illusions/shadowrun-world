(function (global) {
  ...
  const OPTION_DEFS = [
    ...
    { id: 'oneshot', label: 'One-Shot', type: 'check', description: 'Rule: Each static copy executes once and is consumed. Copies move individually between Storage and Active.\n\nCounter: Tar Baby destroys every active copy. Successful Tar Pit corruption destroys every remaining on-deck copy; offline archive software survives.\n\nEff Rating: No change.\n\nDesign: x1.5 Actual: x0.25.' },
