...
Heat decays exponentially based on the current tier's half-life. Higher tiers linger longer. **Inactive PCs (lying low)** decay at 2× the normal rate.
...
Standings decay exponentially toward 0. Positive standings (loyalty) decay **1.5× slower** than negative (hostility fades faster in the shadows).
...
Lying-low PCs decay standings at 2× the normal rate.
