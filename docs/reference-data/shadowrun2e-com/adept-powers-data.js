...
window.ADEPT_POWERS = [
  ...
  { n: "Improved Physical Attributes", pp: "0.5 / 1 / 1.5 PP per +1", act: "always", rated: true, maxLevel: 6, attrChoice: true, ppTier: [0.5, 1, 1.5], modsAttr: 1,
    tiers: "Up to ½ racial max: 0.5 per +1 · up to racial max: 1 per +1 · up to 1.5× racial max: 1.5 per +1",
    ...
    effect: [
      ...
      "Cap: 1.5 × Racial Maximum for that Attribute.",
  ...
  { n: "Increased Reaction", pp: "0.5 / 1 / 2 PP per +1", act: "always", rated: true, maxLevel: 6, ppTier: [0.5, 1, 2], modsPer: { reaction: 1 },
    tiers: "Up to ½ racial max: 0.5 · up to racial max: 1 · up to 1.5× max: 2",
    ...
    effect: [
      ...
      "Cap: 1.5 × Racial Maximum for Reaction.",
