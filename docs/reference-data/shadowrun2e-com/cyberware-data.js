...
window.CYBERWARE = [
  ...
  { n: "Encephalon", cat: "headware", ess: "0.5 – 1.75", cost: "15,000 – 115,000¥ (L1-4)", avail: "6/12 days", index: 2,
    ...
    src: "SHADOW", pg: 49 },
  { n: "Math SPU", cat: "headware", ess: "0.2/lvl", cost: "4,500¥/lvl", avail: "4/7 days", index: 2,
    desc: "A dedicated math small-processing unit that accelerates calculation-heavy mental tasks.",
    effect: ["0.2 Essence and 4,500¥ per level (Rating 1-3).", "Adds its Rating to Intelligence for pure calculation / mathematical tests.", "Aids deckers: adds half its Rating (round down) to the Hacking Pool."],
    rated: true, maxRating: 3, essTbl: [0.2, 0.4, 0.6], costTbl: [4500, 9000, 13500], src: "SHADOW", pg: 48 },
